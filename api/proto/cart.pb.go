...
func (x *RequestPutCart) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestPutCart) ProtoMessage() {}

func (x *RequestPutCart) ProtoReflect() protoreflect.Message {
	mi := &file_cart_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestPutCart.ProtoReflect.Descriptor instead.
func (*RequestPutCart) Descriptor() ([]byte, []int) {
	return file_cart_proto_rawDescGZIP(), []int{4}
}

func (x *RequestPutCart) GetCartId() string {
	if x != nil {
		return x.CartId
	}
	return ""
...
func (x *RequestPutCart) GetArticleId() string {
	if x != nil {
		return x.ArticleId
	}
	return ""
...
var file_cart_proto_rawDesc = []byte{
	...
	0x65, 0x49, 0x64, 0x73, 0x22, 0x46, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50,
	0x75, 0x74, 0x43, 0x61, 0x72, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x61, 0x72, 0x74, 0x49, 0x64,
	...
	,
...
var file_cart_proto_goTypes = []interface{}{
	...
	(*RequestPutCart)(nil),  // 4: cart.RequestPutCart
}
var file_cart_proto_depIdxs = []int32{
	...
	4, // 2: cart.Cart.PutCart:input_type -> cart.RequestPutCart
	1, // 3: cart.Cart.CreateCart:output_type -> cart.ResponseNewCart
	3, // 4: cart.Cart.GetCart:output_type -> cart.ResponseCart
	3, // 5: cart.Cart.PutCart:output_type -> cart.ResponseCart
